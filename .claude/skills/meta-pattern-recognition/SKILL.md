...
description: Spot patterns appearing in 3+ domains to find universal principles - when noticing the same pattern across 3+ different domains or experiencing déjà vu in problem-solving
metadata:
  version: 1.1.0
---
