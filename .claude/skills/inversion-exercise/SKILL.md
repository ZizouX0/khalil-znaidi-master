...
description: Flip core assumptions to reveal hidden constraints and alternative approaches - "what if the opposite were true?" - when stuck on unquestioned assumptions or feeling forced into "the only way" to do something
metadata:
  version: 1.1.0
---
